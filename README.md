...
**This is the "evolution" branch with some large refactorings and experiments going on, many things are unstable and don't work yet, and the documentation is not up to date!**
