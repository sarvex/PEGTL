...
namespace tao::pegtl
{
   ...
   using input_t = internal::fake_buffer_input< internal::defaulted_eager_position_input< internal::careless_text_position< std::size_t >, internal::line_based_input< lf, internal::memory_input< char > > > >;
